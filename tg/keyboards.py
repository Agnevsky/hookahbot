...
MAIN_MENU = _kb([
    ...
    [("📋 Список заказа",  CB_LIST_TOBACCO),  ("📋 Список заказа",    CB_LIST_BAR),   ("📋 Список заказа",  CB_LIST_OTHER)],
    [("🗑 Очистить список",  CB_CLEAR_TOBACCO), ("🗑 Очистить список",    CB_CLEAR_BAR),  ("🗑 Очистить список",  CB_CLEAR_OTHER)],
])
